            ...
            msg.edit(':eight_pointed_black_star:| **Şimdi de ödülü yaz bakalım**').then(msg => {
              message.channel.awaitMessages(filter, {
                ...
                try {
                  ...
                  .setColor("#f558c9")
                  .setDescription(`**${title}** \n🎉'a Basarak Çekilişe katıl \nKalan Süre : ${duration} \n **Başlama Zamanı :** ${hours}:${minutes}:${seconds} ${suffix}`)
                  .setFooter(message.author.username + " (TheGameer Bot Çekiliş Sistemi)", message.author.avatarURL);
                  message.guild.channels.find("name" , room).send(' :heavy_check_mark: **ÇEKİLİŞ BAŞLADI** :heavy_check_mark:' , {embed: giveEmbed}).then(m => {
                     ...
                     setTimeout(() => {
                       ...
                       .setTitle(title)
                       .setColor("#f558c9")
			.setFooter("(TheGameer Bot Çekiliş Sistemi)")
                     ...
                     m.edit('** 🎉 ÇEKİLİŞ BİTTİ 🎉**' , {embed: endEmbed});
                       ...
                       var embedLel = new Discord.RichEmbed()
                        .setColor("#f558c9")
                        .setDescription("Ödülünü destek talebi açarak elde edebilirsin!").setFooter("(TheGameer Bot Çekiliş Sistemi)")
